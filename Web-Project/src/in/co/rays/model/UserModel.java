...
public class UserModel {
	...
	public void add(UserBean bean) throws Exception {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
				    "INSERT INTO user (id, first_name, last_name, login_id, password, dob, address) VALUES (?, ?, ?, ?, ?, ?, ?)");
	...
	public UserBean findByLoginId(String loginId) throws Exception {
	    ...
	    return bean; // Returns null if no user found — which is what we want
	}
